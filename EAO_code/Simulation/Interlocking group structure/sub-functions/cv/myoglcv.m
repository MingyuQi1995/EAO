...
%Output: Delta (the MSE corresponding to each lambda), lambda_min (the lambda with the samllest MSE)

function [Delta, lambda_min] = myoglcv(X, y, lambda_seq, opts, beta_real)
