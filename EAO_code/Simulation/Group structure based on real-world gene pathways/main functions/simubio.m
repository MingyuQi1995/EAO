%%Function to do simulation based on wiki data
%Input: the simudatabio.mat (a modified data from bio), seed
%Output: biores (time and estimation performance that are evaluated based on bio pathway)


function[biores] = simubio(seed)
%%  Oglasso
...
biores = [OG_res wlas_res wsg_res];
end